...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '溜留柳六の部落格', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '德艺双馨の旅游科技博主，欢迎关注🍚', // 作者简介
  ...
  PRISM_THEME_PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM_THEME_PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-holi-theme.css', // 代码块默认主题
